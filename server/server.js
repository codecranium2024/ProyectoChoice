...
app.post('/comunidad', async (req, res) => {
  const {
    nombre_comunidad, presidente_cocode, telefono_contacto1, otro_lider, telefono_contacto2,
  ...
  try {
    ...
    const query = `
      INSERT INTO tb_Comunidad (
        nombre_comunidad, presidente_cocode, telefono_contacto1, otro_lider, telefono_contacto2, tipo_transporte,
    ...
    await connection.execute(query, [
      nombre_comunidad, presidente_cocode, telefono_contacto1, otro_lider || null, telefono_contacto2 || null,
